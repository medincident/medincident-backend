...
-- email is unique per tenant in Zitadel but not strictly enforced on
-- the wire; use a non-unique index so the projector can still upsert
-- in the face of brief collisions during replays.
