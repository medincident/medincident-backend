...
// Error codes emitted by this DI init. Declared at file level so each emit
// site is grep-local; string values carry the component name so interceptors
// can distinguish per-component telemetry.
